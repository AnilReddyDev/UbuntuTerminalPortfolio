...
export default function Terminal() {
      ...
      case "projects":
        newOutput = {
          projectinfo: [
            ...
            {
              name: "SaveUrNotes",
              desc: "Save your Notes is a web application that allows users to save notes and tasks. The application is built with React and TailwindCSS.",
  ...
  return (
    <div className="w-7/12 font-mono h-auto rounded-t-xl shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]">
      ...
      <div className="terminalBodyw-full bg-t-bgc h-[450px] overflow-scroll pl-2 py-2">
